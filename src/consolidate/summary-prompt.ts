...
TÂCHE
Lis le digest et extrais ce qui aura de la valeur dans 6 mois : ce qui a bien marché, les vraies erreurs des deux côtés, les décisions, un score d'exécution, des mots-clés de liaison, la difficulté de la session, et la liste exhaustive des problèmes rencontrés avec leur schéma de résolution.
...
- Si le digest est vide ou illisible : project "", topic "inconnu", tous arrays [], quality_score 0, difficulty {level "medium", why ""}, problems [].
