...
export function buildCorrectPrompt(relPath: string, kind: ConfigKind, content: string, analysis: string, rubric = ""): string {
  return [
    ...
    "4. Applique les corrections de l'analyse (structure XML, why, anglais si pertinent, anti sur-prompting, triggers…).",
    "5. Ne rallonge pas inutilement : densité, pas de remplissage.",
    "",
