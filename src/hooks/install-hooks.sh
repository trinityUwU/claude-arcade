...
Backup : $SETTINGS.bak
Pour desinstaller : edite $SETTINGS et retire les deux entrees dont la
commande contient "$ROOT" sous hooks.SessionStart et hooks.UserPromptSubmit,
ou restaure le backup : cp "$SETTINGS.bak" "$SETTINGS"
EOF
