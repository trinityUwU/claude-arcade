...
import { Code2, FileText, Sparkles, History } from "lucide-react";
...
function UpgradeView({ u, isMd }: { u: Upgrade; isMd: boolean }): React.JSX.Element {
...
export function UpgradeHistory({ relPath, onClose }: { relPath: string; onClose: () => void }): React.JSX.Element {
