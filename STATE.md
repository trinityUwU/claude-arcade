...
- **Reste (B) — vagues suivantes** : LLM-judge pour/contre + puissance quand 2+ process concurrents ; approches multiples par problème (Problem.approaches) intra-session ; densification (re-consolider en v3 pour faire monter occurrences/contradictions).
