...
- **Reste vague 5** : INC.2 couverture (gaps/morts) dans rebuildInsights ; INC.3 graduation + write-back (toggles auto/manuel par catégorie, gate anti-bloat, prompt-architect, élagage=archivage, double filet backup+git).
