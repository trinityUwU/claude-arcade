...
- **Reste vague 5** : INC.3 graduation + write-back (toggles auto/manuel par catégorie, gate anti-bloat, prompt-architect, élagage=archivage, double filet backup+git, + les 2 affinages de gate ci-dessus).
